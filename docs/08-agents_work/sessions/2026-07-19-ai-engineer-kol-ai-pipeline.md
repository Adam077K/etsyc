...
- Specified **an eval dataset per LLM feature — 6 total** (extraction, design-coherence, critic-accuracy w/ labelled slop set, interview-follow-up, copy-quality, beat-classifier) and proposed a **shared eval-harness + cost-log schema** for convergence with Workstream C.
