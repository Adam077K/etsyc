# Customer & Seller Discovery Interviews — 2026-07-14

Transcripts of the first five discovery recordings for the **Etsy × Columbia challenge**.
Four English street interviews (buyers, around Columbia / NYC) and one Hebrew phone call
(an expert seller, consulted as a domain expert before the seller interviews began).
...
**Total:** 11 min 4 s · 3,492 words · transcription cost ≈ $0.15 (two model passes).
