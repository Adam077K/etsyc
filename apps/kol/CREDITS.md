...
| video/two-dots-feed.mp4 | Sharon (adult, the maker) talking to camera in her Two Dots tee — the DISCOVERY/feed film (0:24) | Founder-provided promo video `TWO DOTS (1).mp4`, 2026-07-23; **compliant cut**, source t=4.0→28.0 (a single continuous talking-head shot). EXCLUDED: the child-face b-roll (costume-model beauty shot ~t=1–3.7s of source) pending model-guardian permission; AND the costume-reveal tail (source t≈28s→end) — trimmed at the 24.07s scene cut to drop that tail because it caused a hard loop-jump (costume/raised-hand pop), a mobile crop drift (face pushed left), and burned-in Instagram captions (~0:25). Out-point lands before the scene cut, the black transition, and any caption pixels. Re-encoded 540×960 muted H.264, yuv420p, +faststart. Verified frame-by-frame (1fps, zero internal scene cuts): zero identifiable child faces, zero captions. | none (adult maker) |
