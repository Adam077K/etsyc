...
Evaluate against Etsyc's billion-dollar craft standard:
...
8. **Generic detection:** Does this look like it could be any SaaS dashboard, or does it have Etsyc character?
...
- Generic elements that lack Etsyc character
...
- **DO NOT skip the mobile screenshot.** Half the SMB owners using Etsyc are on mobile. Missing mobile review is an incomplete review.
