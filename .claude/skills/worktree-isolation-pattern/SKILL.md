...
description: "The exact git worktree create, detect, and clean pattern for Etsyc workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, etsyc-specific, workflow, workers]
source: etsyc-authored 2026-05-16
risk: low
---
...
# /Users/adamks/VibeCoding/Etsyc                      abc1234 [main]
# /Users/adamks/VibeCoding/Etsyc/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @etsyc/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @etsyc/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @etsyc/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Etsyc/.worktrees/scan-rate-limit",
  "files_changed": [
