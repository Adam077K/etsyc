...
description: "How to write a Etsyc Routine .md file: required frontmatter fields (schedule, routine_id_env_key, budget, trust-spec parsing), body conventions, and MCP grant patterns. Use when authoring or refining any file under .claude/agents/_routines/."
tags: [orchestration, etsyc-specific, agents, routines]
...
1. Extract spec from `---ETSYC--SPEC-V1-START---` / `---ETSYC--SPEC-V1-END---` sentinels
