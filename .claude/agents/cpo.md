...
```
Reach:      How many Etsyc users or prospects are affected per quarter?
...
## Solution
[What Etsyc builds — what it does and explicitly does NOT do]
...
- **DO NOT assume Stripe.** Etsyc uses Paddle exclusively. Any spec referencing billing must use Paddle terminology: `subscription`, `checkout`, `price_id`, `14-day money-back guarantee`.
